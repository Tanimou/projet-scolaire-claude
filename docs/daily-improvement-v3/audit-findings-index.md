...
| **Total tracked items** | **118** *(+`PF-72`, `PF-73`, `PF-74`, `PF-75`, `PF-76`)* |

Delta since the 2026-08-02 baseline: **+10**. Four were discovered by V3 runs on 2026-08-02 —
...
`.nvmrc`/`ci.yml` pinned a floating Node major that includes the window where the API cannot boot. All follow the same
