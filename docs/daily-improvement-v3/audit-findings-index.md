...
| **Total tracked items** | **115** *(+`PF-72`, `PF-73`)* |

Delta since the 2026-08-02 baseline: **+7**. Four were discovered by V3 runs on 2026-08-02 —
...
it. `PF-73` was found in the same run while verifying *why* the boot check cannot run inside jest. Both follow the same
