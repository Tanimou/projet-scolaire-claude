...
/**
 * `/parent` — the bare portal root (S-E06-5 / AC-2, PF-93).
 *
 ...
 * value can choose the destination (G-AUTHZ). `/parent` sits in the middleware's
 * protected zone, so an unauthenticated or wrong-role visitor is redirected to
 * `/parent/login` before this file runs.
 */
export const dynamic = 'force-dynamic';

export default function ParentPortalRoot() {
  redirect(PORTAL_LANDING.parent);
}
