...
export default async function ParentCommentsPage({
  ...
  const childrenRead = await readParentChildren<StudentSummary>('parent-comments/children');
    ...
    return (
      <PortalShell portal="parent">
        ...
        <ChildrenReadError
          ...
          domain="Les commentaires des enseignants n'ont pas disparu : ils n'ont pas pu être chargés."
        />
      </PortalShell>
    );
  }
